...
router.get('/', authorize([2,3, 4, 5]), resourceTypeController.getResourceTypes); // Manager+ (levels 3-5)
router.get('/:id', authorize([2,3, 4, 5]), resourceTypeController.getResourceTypeById);
