...
const TaskTable = ({ tasks, resourceTypes = [], metadata = {} }) => {
        ...
        <div className="relative" onMouseEnter={() => setIsOpen(true)} onMouseLeave={() => setIsOpen(false)}>
          ...
          {isOpen && (
            <div className="absolute right-0 w-36 bg-white border border-gray-300 rounded shadow-lg z-10">
              <ul className="py-2">
                <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={() => generatePDF(tasks, metadata)}>
                  PDF Report
                </li>
                <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={() => generateExcel(tasks, metadata)}>
                  Excel Report
                </li>
              </ul>
            </div>
