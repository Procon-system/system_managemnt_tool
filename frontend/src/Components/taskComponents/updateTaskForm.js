...
// console.log("seletcts",selectedEvent)
// return (
...
//           <h3 className=" font-semibold bg-blue-400 text-white px-5 py-1 rounded-md hover:bg-blue-400">Event Information</h3>
//           <button
//             type="button"
...
//                   {selectedEvent.image ? (
//                     <img
//                       src={`http://localhost:5000/api/tasks/get-image/${selectedEvent.image}`}
...
//   {selectedEvent.assigned_to.map((user, index) => (
