...
//                color_code: "green",    // Use end from the original event
//                title: "new task",
//               resource,
//             };
...
//           },
//           // Handle single date click to open the create form with the clicked date
// dateClick: (info) => {
...
//     end_time: adjustedStartTime, // End time can initially be the same as start time or set a default duration
//     color_code: "green",
//     title: "new task",
//   };
  
//   console.log("Single date clicked event", newEvent);
//   openCreateForm(newEvent); // Opens the form with pre-filled start time
// },
...
//       start_time: adjustedStartTime, // Adjusted start time for backend
//       end_time: adjustedEndTime, 
//       color_code: event.backgroundColor,    // Use end from the original event
//       title: event.title,         
//     };
